...
public class Setup_Class {
    ...
    public static WebDriver startBrowserOfChoice(String URL, String BrowserChoice) throws InterruptedException {
        //The line below opens life quote .exe from the local machine
  //      Runtime.getRuntime().exec("C:\\Users\\shudufhadzo\\AppData\\Local\\LifeQuote\\LifeQuote\\Life_Quote_UAT.exe");
